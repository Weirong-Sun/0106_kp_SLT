"""
Transformer Encoder + CNN Decoder model for image reconstruction from keypoints
Projects keypoints onto a white canvas to generate images
"""
import torch
...
class ImageDecoder(nn.Module):
    """CNN Decoder to generate images from latent representation"""
...
class KeypointToImageTransformer(nn.Module):
    """Transformer Encoder + CNN Decoder for keypoint to image reconstruction"""
    def __init__(
        self,
        ...
        super(KeypointToImageTransformer, self).__init__()
